        ...
        var request = $.ajax({
            ...
            success: function(response){
                ...
                if (response.status === "success"){
                    ...
                    $("#shrinkresult").replaceWith("<div id='shrinkresult'><div class='alert alert-danger fade in alert-dismissable'> <a href='#' class='close' data-dismiss='alert' aria-label='close'>&times;</a> <strong>SOS! </strong> I can not shrink this link.  Please fix it!</div></div>");
                }
